...
/**
 * view to show revealed card
 * @author Jiyang QI
 *
 */
public class RevealedCardFrame implements Observer{
	 ...
	 */
	public RevealedCardFrame() {
		initialize();
		RevealedCardArea.getObject().addObserver(this);
	...
	private void initialize() {
		frame = new JFrame("Revealed Card");
	...
	private void frameUpdate() {
		...
		cardsButton.forEach(button->button.setVisible(false));
